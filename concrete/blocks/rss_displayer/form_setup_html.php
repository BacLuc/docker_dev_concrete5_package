...
<div class="form-group">
    ...
    <input name="url" class="form-control" placeholder="<?php echo h(t('Feed URL')) ?>"
           value="<?php echo h($rssObj->url) ?>" type="text" required="required"/>
</div>
<div class="form-group">
    <label for="title">
    ...
    <input name="title" class="form-control" placeholder="<?php echo h(t('Feed Title')) ?>"
           value="<?php echo h($rssObj->title) ?>"/>
</div>
<div class="form-group">
...
<script>
    $(document).ready(function () {
        ...
        $('#standardDateFormat').on('change', function () {
            update();
        });
    });
</script>
<div class="form-group">
    ...
    <input name="itemsToDisplay" class="form-control" placeholder="10"
           value="<?php echo h($rssObj->itemsToDisplay) ?>"/>
</div>
<div class="form-group">
    <div class="checkbox">
        <label>
