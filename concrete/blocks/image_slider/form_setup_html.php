...
<script>
    ...
    $(document).ready(function () {
        ...
        sliderEntriesContainer.find('.ccm-image-slider-entry:last-child div[data-field=entry-link-page-selector]').concretePageSelector({
            ...
            'cID': <?php if ($linkType
                             == 1) { ?><?php echo intval($row['internalLinkCID']); ?><?php } else { ?>false<?php } ?>
        });
        <?php }
        } ?>
...
<div id="ccm-tab-content-slides" class="ccm-tab-content">
    <div class="ccm-image-slider-block-container">
        ...
        <div>
            <button type="button"
                    class="btn btn-success ccm-add-image-slider-entry"><?php echo t('Add Slide'); ?></button>
        </div>
    </div>
</div>
...
<div id="ccm-tab-content-options" class="ccm-tab-content">
    ...
    <div class="form-group">
        <div class="radio">
            <label><input type="radio" name="<?php echo $view->field('navigationType'); ?>"
                          value="0" <?php echo $navigationType > 0 ? '' : 'checked'; ?> /><?php echo t('Arrows'); ?>
            </label>
        </div>
    </div>
    <div class="form-group">
        <div class="radio">
            <label><input type="radio" name="<?php echo $view->field('navigationType'); ?>"
                          value="1" <?php echo $navigationType > 0 ? 'checked' : ''; ?> /><?php echo t('Bullets'); ?>
            </label>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="input-group" style="width: 150px">
            <?php echo $form->number('timeout', $timeout ? $timeout : 4000, array('min' => '1', 'max' => '99999')) ?>
    ...
    <div class="form-group">
        ...
        <div class="input-group" style="width: 150px">
            <?php echo $form->number('speed', $speed ? $speed : 500, array('min' => '1', 'max' => '99999')) ?><span
                    class="input-group-addon"><?php echo t('ms'); ?></span>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <?php echo $form->number('maxWidth', $maxWidth ? $maxWidth : 0, array('min' => '0', 'max' => '4000')) ?><span
                class="input-group-addon"><?php echo t('px'); ?></span>
    </div>
</div>

<script type="text/template" id="imageTemplate">
    <div class="ccm-image-slider-entry slide-well slide-closed">
        <button type="button" class="btn btn-default ccm-edit-slide"
        ...
        <div class="form-group">
            ...
            <textarea style="display: none" class="redactor-content"
