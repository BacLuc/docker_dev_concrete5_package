...
if ($cID > 0 && $bID > 0) {
    ...
    if (is_object($b) && !$b->isError()) {
        ...
        if ($bp->canEditBlock()) {
            ...
            ?>
            <div class="ccm-ui">
                <form method="post" id="ccm-gathering-edit-form" action="<?php echo $b->getBlockEditAction() ?>"
                    ...
                    <div class="dialog-buttons">
                        <button class="btn btn-hover-danger pull-left"
                                onclick="jQuery.fn.dialog.closeTop()"><?php echo t('Cancel') ?></button>
                        <button class="btn btn-primary pull-right"
                                onclick="$('#ccm-gathering-edit-form').submit()"><?php echo t('Save') ?></button>
                    </div>
