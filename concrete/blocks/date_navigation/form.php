...
<fieldset>
    ...
    <div class='form-group'>
        ...
        <div class="checkbox">
            <label>
                <input <?php if (intval($cParentID) > 0) { ?>checked<?php } ?> name="filterByParent" type="checkbox"
                       value="1"/>
...
<fieldset>
    ...
    <div class="form-group">
        <div class="checkbox">
            <label>
                <input <?php if (intval($cTargetID) > 0) { ?>checked<?php } ?> name="redirectToResults" type="checkbox"
                       value="1"/>
