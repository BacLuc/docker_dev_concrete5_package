...
<fieldset class="ccm-attribute ccm-attribute-address">
    ...
    <div class="form-group">
        ...
        <div class="radio">
            <label><?php echo $form->radio('akHasCustomCountries', 0,
                    $akHasCustomCountries) ?><?php echo t('All Available Countries') ?></label>
        </div>
        <div class="radio">
            <label><?php echo $form->radio('akHasCustomCountries', 1,
                    $akHasCustomCountries) ?><?php echo t('Selected Countries') ?></label>
        </div>
    </div>
    <div class="form-group">
        <select id="akCustomCountries" name="akCustomCountries[]" multiple size="7" disabled="disabled"
            ...
            <?php foreach ($countries as $key => $val) { ?>
                ...
                <option <?php echo(in_array($key, $akCustomCountries) || $akHasCustomCountries == 0 ? 'selected ' :
    ...
    <div class="form-group">
        ...
        <?php echo $form->select('akDefaultCountry', $countries, $akDefaultCountry,
