...
<fieldset class="ccm-attribute ccm-attribute-address ccm-attribute-address-<?php echo $key->getAttributeKeyID() ?>">
    ...
    <div class="ccm-attribute-address-line ccm-attribute-address-state-province form-group">
        ...
        ?>
        <?php echo $f->select($this->field('state_province_select'), array('' => t('Choose State/Province')),
            $state_province,
            array('classes' => 'form-control', 'ccm-attribute-address-field-name' => $this->field('state_province'))) ?>
        <?php echo $f->text($this->field('state_province_text'), $state_province,
            array('style' => 'display: none', 'ccm-attribute-address-field-name' => $this->field('state_province'))) ?>
    </div>
    <?php
