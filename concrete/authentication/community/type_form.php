...
<div class="alert alert-info">
    ...
    <p><?php echo t('<a href="%s" target="_blank">Click here</a> to obtain your access keys.',
            \Config::get('concrete.urls.concrete5_secure') . '/profile/apps/'); ?></p>
    <p><?php echo t('Set the "Callback URL" to: %s.',
            '<code>' . \URL::to('/ccm/system/authentication/oauth2/community/callback') . '</code>'); ?></p>
</div>
    ...
    <div class="input-group">
        <label type="checkbox">
            <input type="checkbox" name="registration_enabled"
                   value="1" <?php echo \Config::get('auth.community.registration.enabled', false) ? 'checked' : '' ?>>
