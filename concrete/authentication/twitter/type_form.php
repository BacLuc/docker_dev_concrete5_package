...
<div class="alert alert-info">
    ...
    <p><?php echo t('Set the "Callback URL" to:%s.',
            ' <code>' . \URL::to('/ccm/system/authentication/oauth2/twitter/callback') . '</code>'); ?></p>
</div>
    ...
    <div class="input-group">
        <label type="checkbox">
            <input type="checkbox" name="registration_enabled"
                   value="1" <?php echo \Config::get('auth.twitter.registration.enabled', false) ? 'checked' : '' ?>>
