...
<div class="forgotPassword">
    <form method="post" action="<?php echo URL::to('/login', 'callback', $authType->getAuthenticationTypeHandle(),
        'forgot_password') ?>">
        ...
        <button name="resetPassword"
                class="btn btn-primary btn-block"><?php echo t('Reset and Email Password') ?></button>
    </form>
</div>
