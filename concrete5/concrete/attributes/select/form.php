...
if ($akSelectAllowMultipleValues && !$akSelectAllowOtherValues) {
    ...
    foreach ($options as $opt) { ?>
        ...
        <div class="checkbox"><label>
                <?php echo $form->checkbox($view->field('atSelectOptionValue') . '[]',
...
if ($akSelectAllowOtherValues) {
    ...
    ?>
    <input type="hidden" data-select-and-add="<?php echo $akID ?>" style="width: 100%"
           name="<?php echo $view->field('atSelectOptionValue') ?>" value="<?php echo $value ?>"/>
