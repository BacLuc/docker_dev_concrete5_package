...
<div id="ccm-layouts-edit-mode" class="ccm-layouts-edit-mode-edit">
    ...
    <?php foreach ($columns as $col) { ?>
        ...
        <div class="<?php echo $col->getAreaLayoutColumnClass() ?>" id="ccm-edit-layout-column-<?php echo $i ?>"
             <?php if ($iscustom) { ?>data-width="<?php echo $col->getAreaLayoutColumnWidth() ?>" <?php } ?>>
            <div class="ccm-layout-column-inner ccm-layout-column-highlight">
                <input type="hidden" name="width[<?php echo $i ?>]" value=""
                       id="ccm-edit-layout-column-width-<?php echo $i ?>"/>
                <?php
                $col->display(true);
                ?>
            </div>
