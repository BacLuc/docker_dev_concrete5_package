...
class Controller extends BlockController implements ConversationFeatureInterface
{
    ...
    public function duplicate_master($newBID, $newPage)
    {
        ...
        $db->Execute('UPDATE btCoreConversation SET cnvID = ? WHERE bID = ?',
            array($conv->getConversationID(), $newBID));
    }
    ...
    public function edit()
    {
        ...
        $this->set('attachmentsEnabled',
            $fileSettings['attachmentsEnabled'] > 0 ? $fileSettings['attachmentsEnabled'] : '');
        $this->set('attachmentOverridesEnabled',
            $fileSettings['attachmentOverridesEnabled'] > 0 ? $fileSettings['attachmentOverridesEnabled'] : '');
    ...
    public function getFileSettings()
    {
        ...
        $fileExtensions = implode(',',
            $helperFile->unserializeUploadFileExtensions($fileExtensions)); //unserialize and implode extensions into comma separated string
