...
<fieldset>
    ...
    <div class="form-group">
        ...
        <?php echo $form->select('orderBy', array(
            'date_asc' => t('Earliest First'),
            'date_desc' => t('Most Recent First'),
...
<fieldset>
    ...
    <div class="form-group">
        <div class="checkbox">
            <label class="control-label">
                <?php echo $form->checkbox('attachmentOverridesEnabled', 1,
                    $attachmentOverridesEnabled) ?><?php echo t('Enable Attachment Overrides') ?>
            </label>
        </div>
    </div>
    <div class="form-group attachment-overrides">
        ...
        <div class="checkbox">
            <label class="control-label">
                <?php echo $form->checkbox('attachmentsEnabled', 1,
                    $attachmentsEnabled) ?><?php echo t('Enable Attachments') ?>
            </label>
        </div>
    </div>
    <div class="form-group attachment-overrides">
...
<fieldset>
    ...
    <div class="form-group">
        <div class="checkbox">
            <label>
                <?php echo $form->checkbox('notificationOverridesEnabled', 1,
                    $notificationOverridesEnabled) ?><?php echo t('Override Global Settings') ?>
            </label>
        </div>
    </div>
    <div class="form-group notification-overrides">
        <div class="form-group">
            ...
            <?php echo Core::make("helper/form/user_selector")
                           ->selectMultipleUsers('notificationUsers', $notificationUsers) ?>
        </div>
    </div>
    <div class="form-group notification-overrides">
